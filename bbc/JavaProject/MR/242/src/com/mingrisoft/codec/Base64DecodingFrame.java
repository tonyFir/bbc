...
public class Base64DecodingFrame extends JFrame {
    ...
    public Base64DecodingFrame() {
        ...
        JLabel message1Label = new JLabel("\u5DF2\u52A0\u5BC6\u5B57\u7B26\u4E32");
        message1Label.setHorizontalAlignment(SwingConstants.CENTER);
        message1Label.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 16));
        message1Panel.add(message1Label, BorderLayout.NORTH);
        
        message1TextArea = new JTextArea();
        message1TextArea.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 16));
        ...
        JLabel message2Label = new JLabel("\u672A\u52A0\u5BC6\u5B57\u7B26\u4E32");
        message2Label.setHorizontalAlignment(SwingConstants.CENTER);
        message2Label.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 16));
        message2Panel.add(message2Label, BorderLayout.NORTH);
        
        message2TextArea = new JTextArea();
        message2TextArea.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 16));
    ...
    protected void do_button_actionPerformed(ActionEvent arg0) {
        ...
        if (sourceString.length() == 0) {
            JOptionPane.showConfirmDialog(this, "ÇëÊäÈëÒª½âÂëµÄ×Ö·û´®", "", JOptionPane.WARNING_MESSAGE);
            return;
        }
